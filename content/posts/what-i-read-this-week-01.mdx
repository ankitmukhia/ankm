...
- **Ex: ** → **ChatGPT uses cl100k_base tokenizer** 
...
## 12. **Why deep DeepSeek-R1 is big deal?**
...
## 13. **Learning in unverifiable domains(it comes within reinforcement learning)**
