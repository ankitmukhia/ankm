...
export const ProjectPreview = (project: Project) => {
	return (
		<div className="flex flex-col items-start font-satoshi">
		  <div className="group relative -mx-3 w-full space-y-2 transform rounded-lg px-3 py-2 transition-all duration-300 ease-in-out md:hover:scale-105 md:hover:bg-hoverColor/20">
		    ...
		    <p className="text-sm font-thin leading-7">{project.description}</p>
		   </div>
		</div>
	)
}
